...
import tqdm
from sam2object_utils import get_points_from_ply
...
if __name__ == '__main__':
    ...
    res_dir = "/Your/Path/To/Results"  # Change this to your results directory
    data_dir = "/Your/Path/To/ScanNet"  # Change this to your ScanNet data directory
